...
const CyberRadio = ({ options, name, selectedValue, onChange }) => {
  return (
    <StyledWrapper>
      <div className="container">
        {options.map((option, index) => (
          <div className="radio-wrapper" key={option.value}>
            ...
            />
            <div className="btn">
              <span aria-hidden>_</span>{option.label}
              <span className="btn__glitch" aria-hidden>_{option.label}_</span>
              <label className="number">r{index + 1}</label>
            </div>
          </div>
        ))}
      </div>
