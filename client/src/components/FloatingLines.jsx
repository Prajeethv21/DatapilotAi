...
const vec3 PINK  = vec3(0.2, 0.4, 1.0);
const vec3 BLUE  = vec3(0.05, 0.1, 0.4);
...
export default function FloatingLines({
  linesGradient = ['#0066ff', '#00aaff', '#0044cc', '#3388ff'],
  ...
  return (
    <div
      ref={containerRef}
      style={{ width: '100%', height: '100%', position: 'absolute', top: 0, left: 0, overflow: 'hidden', mixBlendMode }}
    />
  );
}
